...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.listen2Events = function () {
        var _this = this;
        this.socket.on("msg", function (data) {
            _this.messages.push(data);
        });
        this.socket.on("getMyId", function (data) {
            _this.clientID = data;
        });
    };
...
module.exports = __webpack_require__(/*! /Users/blakewaldron/Desktop/University/Semester2/FIT2095/Week12/chatApp/src/main.ts */"./src/main.ts");
