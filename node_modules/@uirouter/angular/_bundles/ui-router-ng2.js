...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@uirouter/core'), require('@angular/core'), require('rxjs/ReplaySubject'), require('rxjs/BehaviorSubject'), require('rxjs/observable/of'), require('rxjs/observable/fromPromise'), require('rxjs/observable/combineLatest'), require('rxjs/operator/switchMap'), require('rxjs/operator/map'), require('rxjs/operator/concat'), require('@angular/common'), require('@angular/router'), require('@uirouter/rx')) :
    typeof define === 'function' && define.amd ? define(['exports', '@uirouter/core', '@angular/core', 'rxjs/ReplaySubject', 'rxjs/BehaviorSubject', 'rxjs/observable/of', 'rxjs/observable/fromPromise', 'rxjs/observable/combineLatest', 'rxjs/operator/switchMap', 'rxjs/operator/map', 'rxjs/operator/concat', '@angular/common', '@angular/router', '@uirouter/rx'], factory) :
    (factory((global['@uirouter/angular'] = {}),global['@uirouter/core'],global.ng.core,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.common,global.ng.router,global['@uirouter/rx']));
}(this, (function (exports,core,core$1,ReplaySubject,BehaviorSubject,of,fromPromise,combineLatest,switchMap,map,concat,common,router,rx) { 'use strict';
    ...
    var UISref = /** @class */ (function () {
        function UISref(_router, _anchorUISref, parent) {
             ...
             */
            this.targetState$ = new ReplaySubject.ReplaySubject(1);
    ...
    var UISrefStatus = /** @class */ (function () {
        ...
        UISrefStatus.prototype.ngAfterContentInit = function () {
            ...
            // start -> (success|error)
            var transEvents$ = switchMap.switchMap.call(this._globals.start$, function (trans) {
                var event = function (evt) { return ({ evt: evt, trans: trans }); };
                var transStart$ = of.of(event('start'));
                var transResult = trans.promise.then(function () { return event('success'); }, function () { return event('error'); });
                var transFinish$ = fromPromise.fromPromise(transResult);
                return concat.concat.call(transStart$, transFinish$);
            });
            // Watch the @ContentChildren UISref[] components and get their target states
            // let srefs$: Observable<UISref[]> = of(this.srefs.toArray()).concat(this.srefs.changes);
            this._srefs$ = new BehaviorSubject.BehaviorSubject(this._srefs.toArray());
            this._srefChangesSub = this._srefs.changes.subscribe(function (srefs) { return _this._srefs$.next(srefs); });
            var targetStates$ = switchMap.switchMap.call(this._srefs$, function (srefs) {
                return combineLatest.combineLatest(srefs.map(function (sref) { return sref.targetState$; }));
            });
            // Calculate the status of each UISref based on the transition event.
            // Reduce the statuses (if multiple) by or-ing each flag.
            this._subscription = switchMap.switchMap
                .call(transEvents$, function (evt) {
                return map.map.call(targetStates$, function (targets) {
